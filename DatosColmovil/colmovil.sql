...
copy cliente FROM '/afs/eisc/user/pregrado/2010/luisfemm/Escritorio/DatosColmovil/clientes.csv' DELIMITER ';' CSV;

COPY localizacion FROM '/afs/eisc/user/pregrado/2010/luisfemm/Escritorio/DatosColmovil/localizacion.csv' DELIMITER ';' CSV;

COPY oficina FROM '/afs/eisc/user/pregrado/2010/luisfemm/Escritorio/DatosColmovil/oficinas.csv' DELIMITER ';' CSV;

COPY operador_roaming FROM '/afs/eisc/user/pregrado/2010/luisfemm/Escritorio/DatosColmovil/operador_roaming.csv' DELIMITER ';' CSV;

COPY equipo_celular FROM '/afs/eisc/user/pregrado/2010/luisfemm/Escritorio/DatosColmovil/equipo_celular.csv' DELIMITER ';' CSV;

COPY plan_voz FROM '/afs/eisc/user/pregrado/2010/luisfemm/Escritorio/DatosColmovil/plan_voz.csv' DELIMITER ';' CSV;

COPY plan_datos FROM '/afs/eisc/user/pregrado/2010/luisfemm/Escritorio/DatosColmovil/plan_datos.csv' DELIMITER ';' CSV;

COPY sim_card FROM '/afs/eisc/user/pregrado/2010/luisfemm/Escritorio/DatosColmovil/sim_card.csv' DELIMITER ';' CSV;

COPY contrato FROM '/afs/eisc/user/pregrado/2010/luisfemm/Escritorio/DatosColmovil/contratos_sim_card.csv' DELIMITER ';' CSV;
