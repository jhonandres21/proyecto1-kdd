...
DROP DOMAIN IF EXISTS colmovil_dwh.dominio_genero;
DROP DOMAIN IF EXISTS colmovil_dwh.dominio_dia_noche;
DROP DOMAIN IF EXISTS colmovil_dwh.dominio_periodo_dia;
DROP DOMAIN IF EXISTS colmovil_dwh.dominio_periodo_anio;
DROP DOMAIN IF EXISTS colmovil_dwh.dominio_estado_civil;
...
CREATE DOMAIN dominio_periodo_anio CHAR (30) CHECK ( VALUE IN ( 'Vacaciones_Verano', 'Vacaciones_Invierno', 'Semana_Santa', 'Navidad' ) );
